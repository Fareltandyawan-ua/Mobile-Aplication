...
import 'package:d4tivokasi/features/profile/data/repositories/profile_repository.dart';
...
class ProfileNotifier extends StateNotifier<AsyncValue<ProfileModel>> {
  ...
  /// Update nama (contoh edit profil)
  void updateNama(String newNama) {
    state.whenData((profile) {
      state = AsyncValue.data(profile.copyWith(nama: newNama));
    });
  }
}

// Profile Notifier Provider dengan autoDispose
